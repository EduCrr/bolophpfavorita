...
<div class="page-content-wrap">
	<div class="row">
		<div class="col-md-12">
			...
			<?php echo $this->Form->create($ambiente, ['url' => ['controller' => 'ambientes', 'action' => 'adicionar'], 'class' => 'form-horizontal', 'type' => 'file', 'novalidate' => true, 'templates' => ['inputContainer' => '{{content}}']]); ?>
