...
<div class="page-title">
	<h2><span class="fa fa-bed"></span> Ambientes</h2>
		...
		<div class="col-md-12">
			...
			<div class="panel panel-default">
				<div class="panel-heading clearfix">
					...
					<?php echo $this->Html->link('<span class="fa fa-plus"></span> Novo ambiente', ['controller' => 'ambientes', 'action' => 'adicionar'], ['escape' => false, 'class' => 'btn btn-primary pull-right']); ?>
				</div>
				<div class="panel-body padding-bottom-0">
					<div class="row">
						<?php if ($ambientes->count()) { ?>
							<div class="ordenable" data-action="<?php echo $this->Url->build(['controller' => 'ambientes', 'action' => 'ordenar']) ?>">
									...
									<div class="col-md-3 col-lg-3 col-sm-6 col-xs-12 push-down-20" id="odr_<?php echo $value->id; ?>">
										<div class="panel panel-primary push-down-0">
											<div class="panel-heading">
												<?php echo $this->Form->create($value, ['url' => ['controller' => 'ambientes', 'action' => 'visibilidade', $value->id], 'class' => 'pull-left visibilidade', 'type' => 'file']); ?>
												...
												<h3 class="panel-title" style="text-overflow: ellipsis; white-space: nowrap; width: -webkit-calc(100% - 40px); width: -moz-calc(100% - 40px); width: calc(100% - 40px);  overflow: hidden;"><?php echo $value->nome; ?></h3>

											</div>

											<div class="panel-body" style=" width: 100%; overflow: hidden; text-overflow: ellipsis; white-space: nowrap;">
												<?php echo $this->Html->image('/content/ambients/' . $value->imagem, array('class' => 'center img-thumbnail')); ?>
											</div>

											<div class="panel-footer">
												<ul class="panel-controls" style="margin-top: 2px;">
													<li><?php echo $this->Html->link('<i class="fa fa-edit"></i>', ['controller' => 'ambientes', 'action' => 'editar', $value->id], ['escape' => false]); ?></li>
													...
													<div class="mb-middle">
														...
														<div class="mb-footer">
															<div class="pull-right">
																<?php echo $this->Form->postLink('Sim', ['controller' => 'ambientes', 'action' => 'excluir', $value->id], ['class' => 'btn btn-primary btn-lg']); ?>
