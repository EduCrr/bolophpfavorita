...
<div class="page-title">
	<h2><span class="fa fa-arrow-down"></span> Editar</h2>
</div>
<!-- END PAGE TITLE -->
...
<div class="page-content-wrap">
	<div class="row">
		<div class="col-md-12">
			...
			<?php echo $this->Form->create($download, ['url' => ['controller' => 'downloads', 'action' => 'editar', $download->id], 'class' => 'form-horizontal', 'type' => 'file', 'novalidate' => true, 'templates' => ['inputContainer' => '{{content}}']]); ?>
			<div class="panel panel-default">
				...
				<div class="panel-body form-group-separated">
					...
					<div class="form-group">
								...
								<div class="btn btn-white">
									<span class="fileupload-filename">
										<?php if ($download->arquivo) { ?>
											<?php echo $this->Html->link('Ver documento', ['controller' => 'downloads', 'action' => 'download', $download->id]); ?>

											<?php echo $this->Html->link('<i class="fa fa-trash"></i>', 'javascript:void(0);', ['escape' => false, 'class' => 'text-danger mb-control', 'target' => '_blank', 'data-box' => '#delete-file-' . $download->id]); ?>
						...
						<!-- MESSAGE BOX-->
						<div class="message-box animated fadeIn message-box-warning" id="delete-file-<?php echo $download->id; ?>">
								...
								<div class="mb-middle">
									...
									<div class="mb-footer">
										<div class="pull-right">
											<?php echo $this->Form->postLink('Sim', ['controller' => 'download', 'action' => 'excluirArquivo', $download->id], ['block' => true, 'class' => 'btn btn-primary btn-lg']); ?>
