...
<div class="page-content-wrap">
	<div class="row">
		<div class="col-md-12">
			...
			<?php echo $this->Form->create($estilo, ['url' => ['controller' => 'estilos', 'action' => 'adicionar'], 'class' => 'form-horizontal', 'type' => 'file', 'novalidate' => true, 'templates' => ['inputContainer' => '{{content}}']]); ?>
