...
<div class="page-content-wrap">
	<div class="row">
		<div class="col-md-12">
			...
			<?php echo $this->Form->create($produto, ['url' => ['controller' => 'produtos', 'action' => 'editar', $produto->id], 'class' => 'form-horizontal', 'type' => 'file', 'novalidate' => true, 'templates' => ['inputContainer' => '{{content}}']]); ?>
					...
					<div class="form-group">
						<div class="col-md-4 col-lg-4 col-sm-10 col-xs-12">
							...
							<div class="input-group">
								...
								<?php $this->Form->unlockField('categoria'); ?> 
						...
						<div class="col-md-8 col-lg-8 col-sm-10 col-xs-12">
							...
							<div class="fileupload fileupload-new">
								<div class="fileupload-new thumbnail" style="max-width: 480px;">
									<?php echo $this->Html->image('/content/products/' . $produto->categoria . DS . $produto->imagem, ['style' => 'width: auto; max-width: 100%;']); ?>
								</div>
