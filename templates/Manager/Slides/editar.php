...
<div class="page-title">
	<h2><span class="fa fa-home"></span> Editar</h2>
...
<div class="page-content-wrap">
	<div class="row">
		<div class="col-md-12">
			...
			<?php echo $this->Form->create($slide, ['url' => ['controller' => 'slides', 'action' => 'editar', $slide->id], 'class' => 'form-horizontal', 'type' => 'file', 'novalidate' => true, 'templates' => ['inputContainer' => '{{content}}']]); ?>
						...
						<div class="col-md-8 col-lg-8 col-sm-10 col-xs-12">
							...
							<div class="fileupload fileupload-new">
								<div class="fileupload-new thumbnail" style="max-width: 480px;">
									<?php echo $this->Html->image('/content/slides/' . $slide->imagem, ['style' => 'width: auto; max-width: 100%;']); ?>
								</div>
