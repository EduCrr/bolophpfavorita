...
<div class="page-content-wrap">
	<div class="row">
		<div class="col-md-12">
			...
			<?php echo $this->Form->create($post, ['url' => ['controller' => 'blog', 'action' => 'editar', $post->id], 'class' => 'form-horizontal', 'type' => 'file', 'novalidate' => true, 'templates' => ['inputContainer' => '{{content}}']]); ?>
						...
						<div class="col-md-8 col-lg-8 col-sm-10 col-xs-12">
							...
							<div class="fileupload fileupload-new">
								<div class="fileupload-new thumbnail" style="max-width: 480px;">
									<?php echo $this->Html->image('/content/posts/' . $post->imagem, ['style' => 'width: auto; max-width: 100%;']); ?>
								</div>
							...
							<div>
								...
								<span>
									A imagem deve ter no mínimo <b>1920px</b> de largura e <b>300px</b> de altura.
								</span>
							</div>
						</div>
					</div>
					<div class="form-group">
						<div class="col-md-4 col-lg-4 col-sm-10 col-xs-12">
							...
							<div class="input-group">
								...
								<?php echo $this->Form->control('publicado', ['type' => 'text', 'class' => 'form-control datetime-picker mask-datetime', 'label' => false, 'value' => $post->publicado ? $post->publicado->format('d/m/Y H:i') : null]); ?>							</div>
							<span class="help-block with-errors"></span>
						</div>
					</div>
					<div class="form-group">
