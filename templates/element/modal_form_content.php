<div class="btn-group btn-group-xs" style="vertical-align: bottom;">
	<?php echo $this->Html->link('<i class="fa fa-edit"></i>', 'javascript:void(0);', ['escape' => false, 'class' => 'btn btn-default', 'data-toggle' => 'modal', 'data-target' => '#modal_large-' . $conteudo->id, 'style' => 'padding-top: 2px;']); ?>
</div>


<div class="modal" id="modal_large-<?php echo $conteudo->id; ?>" tabindex="-1" role="dialog" aria-labelledby="largeModalHead" aria-hidden="true">
	<div class="modal-dialog modal-lg">
		<?php echo $this->Form->create($conteudo, ['url' => ['controller' => 'conteudos', 'action' => 'editar', $conteudo->id], 'class' => 'modal-content form-horizontal', 'type' => 'file', 'novalidate' => true, 'templates' => ['inputContainer' => '{{content}}']]); ?>
			<div class="modal-header">
				<button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">&times;</span><span class="sr-only">Close</span></button>
				<h4 class="modal-title" id="largeModalHead"><?php echo $conteudo->parametro->descricao ?? 'Editar informações'; ?></h4>
			</div>
			<div class="modal-body form-group-separated">
				...
				<div class="form-group">
					...
					<div class="col-md-12 col-lg-12 col-sm-10 col-xs-12">
						...
						<div class="fileupload fileupload-new">
							<div class="fileupload-new thumbnail" style="max-height: 480px; max-width: 480px;">
